...
| 目录 | 做什么 |
|---|---|
| [between_rounds/](between_rounds/) | `round_end` 之后原子替换 prompt |
| [digest_watch/](digest_watch/) | 打印 `config_digest` / `config_changed` |
| [outer_loop/](outer_loop/) | 2026 harness 对照（Dream-RSI、ACE、Ralph、Codex 内环 vs 我们的外环） |
