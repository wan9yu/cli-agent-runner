...
def test_detect_supervisor_stale_should_fire_when_pause_window_ends_without_resume():
...
def test_detect_supervisor_stale_should_fire_when_stale_after_resume():
    now = datetime(2026, 8, 22, 13, 0, tzinfo=UTC)
...
def test_detect_supervisor_stale_should_fire_when_resume_at_empty_past_8day_horizon():
