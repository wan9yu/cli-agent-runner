...
def test_cmd_should_return_78_when_run_one_round_raises_config_error(monkeypatch, capsys):
...
def test_cmd_should_return_78_when_config_file_is_missing(monkeypatch, tmp_path, capsys):
    monkeypatch.setattr(round_cmd, "_install_term_handler", lambda: None)
...
def test_cmd_should_return_78_when_toml_is_malformed(monkeypatch, tmp_path, capsys):
    monkeypatch.setattr(round_cmd, "_install_term_handler", lambda: None)
