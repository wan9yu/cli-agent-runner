...
def test_non_utf8_byte_in_round_log_should_not_raise_when_invoked(tmp_path: Path) -> None:
...
def test_open_round_log_should_pin_errors_replace_when_invoked(tmp_path: Path) -> None:
