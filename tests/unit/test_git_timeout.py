...
def test_run_with_timeout_should_escalate_to_killpg_when_term_ignored(tmp_path, monkeypatch):
...
def test_foreign_lock_should_stay_untouched_when_git_fails_without_timeout(tmp_path, monkeypatch):
