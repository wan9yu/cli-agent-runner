...
def test_malformed_events_prefix_select_should_be_accepted_when_parsed(capsys):
...
def test_select_path_should_raise_key_error_when_selecting_removed_events_kind():
