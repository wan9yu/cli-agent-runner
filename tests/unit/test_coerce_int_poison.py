...
def test_check_throttle_state_should_leave_serve_unthrottled_and_warn_when_reset_at_epoch_is_nan(
    tmp_path: Path,
) -> None:
...
def test_check_throttle_state_should_leave_serve_unthrottled_and_warn_when_reset_at_epoch_is_inf(
    tmp_path: Path,
) -> None:
