...
def test_rate_limit_event_should_classify_as_rate_limit_account_when_invoked(tmp_path):
...
def test_5xx_error_should_classify_as_api_transient_5xx_when_invoked(tmp_path, api_error_status):
    from agent_runner.builtin_plugins.claude_rate_limit import ClaudeErrorDetector
...
def test_408_status_should_classify_as_api_timeout_when_invoked(tmp_path):
    from agent_runner.builtin_plugins.claude_rate_limit import ClaudeErrorDetector
...
def test_successful_round_should_not_emit_transient_error_when_invoked(tmp_path):
    from agent_runner.builtin_plugins.claude_rate_limit import ClaudeErrorDetector
...
def test_non_claude_preset_should_not_emit_transient_error_when_invoked(tmp_path):
    from agent_runner.builtin_plugins.claude_rate_limit import ClaudeErrorDetector
...
def test_403_status_should_not_emit_transient_error_when_invoked(tmp_path):
...
def test_missing_round_log_should_not_emit_else_crash_when_invoked(tmp_path):
    from agent_runner.builtin_plugins.claude_rate_limit import ClaudeErrorDetector
...
def test_successful_round_should_emit_usage_event_when_invoked(tmp_path):
...
def test_5xx_error_should_emit_both_transient_error_and_usage_events_when_invoked(tmp_path):
    from agent_runner.builtin_plugins.claude_rate_limit import ClaudeErrorDetector
...
def test_assistant_event_should_populate_model_in_usage_event_when_invoked(tmp_path):
...
def test_missing_assistant_event_should_default_model_to_unknown_when_invoked(tmp_path):
    from agent_runner.builtin_plugins.claude_rate_limit import ClaudeErrorDetector
...
def test_429_with_null_rate_limit_type_should_classify_as_rate_limit_model_when_invoked(tmp_path):
...
def test_rate_limit_event_with_null_type_and_no_result_should_have_no_transient_error_when_invoked(
    tmp_path,
):
...
def test_tool_use_blocks_should_populate_tool_call_count_when_invoked(tmp_path):
    from agent_runner.builtin_plugins.claude_rate_limit import _parse_claude_log
...
def test_hook_context_phase_should_surface_in_usage_event_when_invoked(tmp_path):
    from agent_runner.builtin_plugins.claude_rate_limit import ClaudeErrorDetector
...
def test_missing_phase_should_default_to_empty_string_in_usage_event_when_invoked(tmp_path):
...
def test_failed_round_should_set_success_false_in_usage_event_when_invoked(tmp_path):
    from agent_runner.builtin_plugins.claude_rate_limit import ClaudeErrorDetector
...
def test_custom_agent_name_with_claude_binary_should_emit_usage_event_when_invoked(tmp_path):
...
def test_repetitive_tool_should_emit_anomaly_only_when_at_else_above_threshold(
...
def test_non_claude_binary_should_not_emit_usage_event_when_invoked(tmp_path):
...
def test_529_overloaded_status_should_classify_as_api_transient_5xx_when_invoked(tmp_path):
...
def test_emit_transient_error_detected_should_redact_secrets_in_raw_field_when_invoked(tmp_path):
