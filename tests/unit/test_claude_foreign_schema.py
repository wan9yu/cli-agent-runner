...
def test_parse_claude_log_should_extract_usage_when_rate_limit_info_is_null(
    tmp_path: Path,
) -> None:
    log = _write(
        tmp_path,
...
def test_parse_claude_log_should_emit_usage_and_detection_when_resets_at_is_null(
    tmp_path: Path,
) -> None:
    log = _write(
        tmp_path,
...
def test_after_round_should_still_emit_usage_when_detection_emit_fails(tmp_path: Path) -> None:
    log = _write(
        tmp_path,
        [
            {
...
def test_parse_claude_log_should_degrade_reset_at_epoch_when_resets_at_is_infinity(
    tmp_path: Path,
) -> None:
    log = _write(
        tmp_path,
...
def test_parse_claude_log_should_zero_fill_input_tokens_when_null(tmp_path: Path) -> None:
    log = _write(
        tmp_path,
        [
            {
