...
def test_fresh_eyes_every_n_should_be_set_when_configured(tmp_path: Path):
...
def test_fresh_eyes_every_n_should_default_to_none_when_not_configured(tmp_path: Path):
