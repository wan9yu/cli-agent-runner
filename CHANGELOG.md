...
- `[goal]` ledger: the round child truncates to 8192 bytes; extra notes belong in another `[prompt] files` entry.
- `docs/commands.md`: a loop of `round` is not a substitute for `serve`.
